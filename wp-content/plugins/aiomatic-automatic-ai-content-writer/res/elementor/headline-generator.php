...
if (!class_exists('Aiomatic_Headline_Generator'))
{
    class Aiomatic_Headline_Generator 
    {
        public function __construct() 
        {
            ...
            add_action('wp_ajax_nopriv_aiomatic_generate_headline', array($this, 'generate_headline'));
            add_action('wp_ajax_aiomatic_generate_headline', array($this, 'generate_headline'));
        }

        public function register_headline_generation_controls(Controls_Stack $element, $section_id) 
        {
            $element->add_control(
                'aiomatic_headline_generation',
                [
                    'label' => esc_html__('Aiomatic Headline Generator', 'aiomatic-automatic-ai-content-writer'),
            ...
            $element->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'rows' => 2,
                    'description' => esc_html__('Enter the topic and any specific instructions for the headline you need generated. You can also use the %%content%% shortcode to get the current headline of the widget - useful for rewriting.', 'aiomatic-automatic-ai-content-writer'),
                    'dynamic' => [
                        'active' => true,
                    ],
                ]
            ...
            $element->add_control(
                ...
                [
                    ...
                    'button_type' => 'default',
                    'event' => 'aiomatic:headline:generate'
        ...
        public function generate_headline() 
        {
            ...
            try {
                ...
                $prompt = 'Don\'t act as an AI assistant, write only the content you are asked. Write me one or more headlines for the topic and instructions that follow: ' . $_POST['prompt'] . '\n';
