...
//        $this->readabilityDataTable = $param;
    ...
    {
        $textLength = readability_mb_strlen($this->getTextContent(true));
        if ($textLength == 0) {
            return 0;
        }
        ...
        if ($links) {
            ...
            foreach ($links as $link) {
                ...
                $linkLength += readability_mb_strlen($link->getTextContent(true)) * $coefficient;
            }
        }
    ...
    public function isElementWithoutContent()
    {
        ...
        readability_mb_strlen(preg_replace(NodeUtility::$regexps['onlyWhitespace'], '', $this->textContent)) === 0 &&
            ($this->childNodes->length === 0 ||
                 ...
                 * readability_mb_strlen in this chain of checks).
                 */
    ...
    {
        return ($this->nodeType === XML_TEXT_NODE && readability_mb_strlen(trim($this->textContent)) === 0) ||
