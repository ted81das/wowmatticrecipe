...
/**
 * Abstract FlowMattic_Background_Process class.
 *
 * @abstract
 * @extends FlowMattic_Async_Request
 */
abstract class FlowMattic_Background_Process extends FlowMattic_Async_Request {
	...
	protected function lock_process() {
		...
		$lock_duration = ( property_exists( $this, 'queue_lock_time' ) ) ? $this->queue_lock_time : 30; // 30 sec.
